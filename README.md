...
<html>
    ...
    <body>
        ...
        <h2>Things you will need see:</h2>
        <ul style="float:left;">
           <li> Big Ben</li>
           <li>London Eye</li>
           <li>Tower Bridge</li>
        ...
        <img src="https://www.kasandbox.org/programming-images/space/planet.png">
        <h3>Why should you go there</h3>
        <ol>
        <li> <strong>The history</strong>
        <p class="london">
        ...
        <li><strong>The unexpected bits</strong>
        <p class="london">
